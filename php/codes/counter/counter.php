...
$counter_user     = "d0266d10";
$counter_password = "8RZ8UQLNXHEJG7fR";
$counter_database = "d0266d10";
...
if ($counter_connected == true) {
    ...
    $counter_heute      = $day_value;
    $counter_gestern    = $yesterday_value;
    $counter_week       = $week_value;
    $counter_month      = $month_value;
    $counter_year       = $year_value;
    $counter_gesamt     = $all_value;
    $counter_record     = $record_value;
    $counter_record_day = date("d.m.Y", strtotime($record_date));
